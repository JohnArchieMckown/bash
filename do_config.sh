...
CC=xlc CFLAGS='-g -qtarg=zosv1r12 -qskipsrc=hide -qarch=5 -qtune=7 -qlanglvl=extended:longlong -D_LARGE_FILES -D_ALL_SOURCE -D_ISOC99_SOURCE -O2' \
       CPPFLAGS='-qtarg=zosv1r12 -qskipsrc=hide -qarch=5 -qtune=7 -qlanglvl=extended:longlong -D_LARGE_FILES -D_ALL_SOURCE -D_ISOC99_SOURCE -O2'
